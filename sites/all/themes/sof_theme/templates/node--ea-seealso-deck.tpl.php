...
<article id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  <!-- Image -->
  	<a href="<?php print $node->field_external_link['und'][0]['url']; ?>" rel="bookmark"><?php  print render ($content['field_image_slider']);?></a>
	<!-- Post Date -->
  <p class="author-datetime"><?php print $submitted; ?></p>
  <!-- Title -->
  <?php if ($title): ?>
    <h1<?php print $title_attributes; ?>>
      <?php if ($links = render($content['field_external_link'])): ?>
        <a href="<?php print $node->field_external_link['und'][0]['url']; ?>" rel="bookmark"><?php print $title; ?></a>
      <?php endif; ?>
    </h1>
  <?php endif; ?>
  <!-- Teaser -->
  ...
  <!-- Read More -->
  <nav class="read-more"<?php print $links_attributes; ?>>
